...
public function Faltantes()
  {
    return $this->pdo->query("SELECT * FROM empleados WHERE encuesta_terminada = 0");
  }
  
...
{
$sql = "UPDATE `empleados` SET `encuesta_terminada` = 0 WHERE `empleados`.`encuesta_terminada` = 1";
      $query = $this->pdo->prepare($sql);
      $query->execute();
...
return $this->pdo->query("SELECT * FROM respuestas");
